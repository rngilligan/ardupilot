...
public:
    ...
    enum class Number : uint8_t {
        ...
        PLND_LAND =    29,  // custom precision landing flight mode to separate behavior from normal landing
        PLND_RTL =     30,  // custom preicison rtl flight mode to separate behavior from normal rtl
...
class ModePlndLand : public Mode {

public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::PLND_LAND; }
...
protected:
    ...
    const char *name() const override { return "PLNDLAND"; }
...
public:
    // inherit constructor
    using Mode::Mode;
    Number mode_number() const override { return Number::PLND_RTL; }
...
protected:
    ...
    const char *name() const override { return "PLNDRTL"; }
